...
| Package | Description |
|---------|-------------|
| [@hardlydifficult/ai](./packages/ai) | Unified AI SDK integration with LLMs (Anthropic, Ollama), agent orchestration, and structured output parsing |
...
| [@hardlydifficult/text](./packages/text) | Text manipulation: chunking, formatting, YAML/JSON conversion, YAML healing, and templating |
