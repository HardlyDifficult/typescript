...
```bash
curl -s https://raw.githubusercontent.com/vercel-labs/agent-skills/main/skills/composition-patterns/SKILL.md
```

If the skill references supporting files, fetch those as needed:

```bash
curl -s https://raw.githubusercontent.com/vercel-labs/agent-skills/main/skills/vercel-composition-patterns/path/to/file
```
