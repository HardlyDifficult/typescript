/**
 * Utility functions for AI tool interaction logging.
 */
...
export function sanitizeToolInput(
  ...
  // Verify tool - no sanitization needed, inputs are just enum values
  // Search tools - no sanitization needed, inputs are short strings

  // Bash - keep full command (user should be aware of what's being executed)
  // No sanitization needed

  // WebFetch/WebSearch - keep URL and prompt
  // No sanitization needed for these

  return sanitized;
}

/**
 * Truncate a string to a maximum length, adding an ellipsis indicator.
 *
