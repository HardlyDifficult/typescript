...
describe('convertMarkdown', () => {
  describe('platform: markdown', () => {
    it('preserves bold formatting', () => {
      expect(convertMarkdown('**bold text**', 'markdown')).toBe('**bold text**');
    });

    it('preserves italic formatting', () => {
      expect(convertMarkdown('*italic text*', 'markdown')).toBe('*italic text*');
    });

    it('preserves strikethrough formatting', () => {
      expect(convertMarkdown('~~strikethrough text~~', 'markdown')).toBe('~~strikethrough text~~');
    });
  ...
  describe('platform: slack', () => {
    ...
    it('converts strikethrough to slack format', () => {
      expect(convertMarkdown('~~strikethrough text~~', 'slack')).toBe('~strikethrough text~');
    });
  ...
  describe('platform: discord', () => {
    ...
    it('preserves strikethrough formatting', () => {
      expect(convertMarkdown('~~strikethrough text~~', 'discord')).toBe('~~strikethrough text~~');
    });
  ...
  describe('platform: plaintext', () => {
    ...
    it('strips strikethrough formatting', () => {
      expect(convertMarkdown('~~strikethrough text~~', 'plaintext')).toBe('strikethrough text');
    });
  ...
  describe('edge cases', () => {
    ...
    it('handles multiple italic sections', () => {
      ...
      expect(convertMarkdown('*first* and *second*', 'slack')).toBe('_first_ and _second_');
    });
  });
});
